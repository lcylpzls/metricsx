...
func (m *Metrics) AddCounter(name string, delta float64, labels ...string) // v1.1.0
func (m *Metrics) AddGauge(name string, delta float64, labels ...string)   // v1.1.0
func (m *Metrics) SetGauge(name string, value float64, labels ...string)   // v1.1.0
...
- `AddGauge("webx.inflight", 1)` → GaugeVec `myapp_webx_inflight`;
- `SetGauge("webx.connections", 3)` → GaugeVec 瞬时值 3;
- `AddCounter("filex.bytes", 1024, "bucket", "put")` →
  CounterVec `myapp_filex_bytes_total` 累加 1024;
...
| v0.5.0 | 工业级打磨与自我审查 |
| v1.0.0 | 正式版,API 冻结 |
| v1.1.0 | AddCounter / AddGauge / SetGauge,家族统一标准化接入 |
